...
public class YcLineRenderer extends LineRadarRenderer {
    ...
    protected void drawHorizontalBezier(ILineDataSet dataSet) {
        ...
        int[] colors = new int[]{Color.parseColor("#fd1b1b"), Color.parseColor("#fafd1b"), Color.parseColor("#401bfd"), Color.parseColor("#12fe00")};
        float[] positions = new float[]{0.25f, 0.25f, 0.25f, 0.25f};//比例
        mRenderPaint.setShader(new LinearGradient(0, 0, 0, mChart.getHeight(), colors, positions, Shader.TileMode.CLAMP));
